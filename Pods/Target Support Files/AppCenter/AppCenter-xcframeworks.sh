...
variant_for_slice()
{
  ...
  "AppCenterCrashes.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "AppCenterDistribute.xcframework/ios-arm64_arm64e")
    echo ""
    ;;
  "AppCenterDistribute.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  esac
}
...
install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenterDistribute.xcframework" "AppCenter/Distribute" "framework" "ios-arm64_arm64e" "ios-arm64_x86_64-simulator"
